...
.pulll-left[
Birth numbers are low for Polk County, and will continue to decline in the future as fertilty rates decrease.
]
...
.pulll-left[
Deaths in Polk County will increase as the population ages.
]
...
.pulll-left[
Polk's population age structure will continue to be heavily influenced by the college age population. 
]
...
.pulll-left[
Polk's non-White population will continue to grow more quickly than the White population.
]
...
---
# Dallas Beyond the Census

```{r echo = FALSE, message = FALSE, warning = FALSE, out.height="500px", out.width="750px"}

ggplotly(city_est_plots[[focus_county]][["Dallas"]], tooltip = "text")
```
...
ggplotly(hu_est_plots[[focus_county]][["Dallas"]], tooltip = "text")
```
...
---
# Falls City Beyond the Census

```{r echo = FALSE, message = FALSE, warning = FALSE, out.height="500px", out.width="750px"}

ggplotly(city_est_plots[[focus_county]][["Falls City"]], tooltip = "text")
```
...
ggplotly(hu_est_plots[[focus_county]][["Falls City"]], tooltip = "text")
```
...
# Independence Beyond the Census

```{r echo = FALSE, message = FALSE, warning = FALSE, out.height="500px", out.width="750px"}

ggplotly(city_est_plots[[focus_county]][["Independence"]], tooltip = "text")
```
---
...
ggplotly(hu_est_plots[[focus_county]][["Independence"]], tooltip = "text")
```
---
...
# Monmouth Beyond the Census

```{r echo = FALSE, message = FALSE, warning = FALSE, out.height="500px", out.width="750px"}

ggplotly(city_est_plots[[focus_county]][["Monmouth"]], tooltip = "text")
```
---
...
ggplotly(hu_est_plots[[focus_county]][["Monmouth"]], tooltip = "text")
```
---
...
# Willamina Beyond the Census

```{r echo = FALSE, message = FALSE, warning = FALSE, out.height="500px", out.width="750px"}

ggplotly(city_est_plots[[focus_county]][["Willamina"]], tooltip = "text")
```
---
...
ggplotly(hu_est_plots[[focus_county]][["Willamina"]], tooltip = "text")
```
---
