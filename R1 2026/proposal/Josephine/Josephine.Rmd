...
![destination](./grants_pass_article.png)

---
# Summary of Considerations

- Population growth has been slowing
- Growing impact of negative natural change
- Net migration had been stable
- Net migration now expected to pick up in forecast
- Mostly updates to Grant's Pass
...
.pulll-left[
Population growth is expected to continue, albeit at a slower rate than what has been seen in the past.
]
