...
.pulll-left[
Natural change has recently contributed to population decline and we expect this to continue at a greater magnitude in the future.
]
...
.pulll-left[
Births are expected to continue to fall with some rebounding in later years but not enough to reverse natural decline.
]
...
.pulll-left[
Deaths are forecasted to continue to increase as the population ages.
]
...
.pulll-left[
Lane's population structure will continue to be impacted by college age populations even as the population ages.
]
...
.pulll-left[
Lane's non-White population will continue to grow at a faster rate compared to the White population.
]
...
```{r echo = FALSE, message = FALSE, warning = FALSE, out.height="425px", out.width="750px"}
...
# Lane County: Coburg UGB Boundaries
...
```{r echo = FALSE, message = FALSE, warning = FALSE,out.width="750px", out.height="500px", dpi=300}
ugb_plots$gr_compare[[focus_county]]$`Coburg`
```
