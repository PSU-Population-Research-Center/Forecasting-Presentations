...
- Natural change has been on the decline
- Net migration is still healthy
- No changes made since December

---

# Jefferson at a Glance: 2020 Census

```{r echo = FALSE, message = FALSE, warning = FALSE}
library(tidyverse)
library(plotly)
focus_county <- "Jefferson"
model <- "model_41"
...
.pulll-left[
Jefferson county is expected to growth in the forecast period, albeit at a slower rate then previously observed.
]
...
# Jefferson Compositional Changes

.pulll-left[
Natural change has been on the decline leading to slower population growth.
]
...
.pulll-left[
Births have been on the decline, a trend that is expected to continue through teh forecast period.
]
...
.pulll-left[
Jefferson county is expected to continue to age, leading to a "top-heavy" population structure.
]
...
# Jefferson Race and Ethnicity

.pulll-left[
The population is expected to continue to diversify, with strong growth seen among the Hispanic population.
]
...
# Jefferson UGB Population Changes
...
# Jefferson UGBs: Culver in Context

.pux-right[
```{r echo = FALSE, message = FALSE, warning = FALSE,out.width="800px", out.height="400px", dpi=300}
ugb_plots$hist_pop_house_plot[[focus_county]]$`Culver`
```
]
...
# Jefferson County: Culver UGB Boundaries
...
```{r echo = FALSE, message = FALSE, warning = FALSE,out.width="750px", out.height="500px", dpi=300}
ugb_plots$gr_compare[[focus_county]]$`Culver`
```
...
# Jefferson UGBs: Madras in Context

.pux-right[
```{r echo = FALSE, message = FALSE, warning = FALSE,out.width="800px", out.height="400px", dpi=300}
ugb_plots$hist_pop_house_plot[[focus_county]]$`Madras`
```
]
...
# Jefferson County: Madras UGB Boundaries
...
# Madras UGB Pop Forecast

```{r echo = FALSE, message = FALSE, warning = FALSE,out.width="750px", out.height="500px", dpi=300}
ugb_plots$ind_ugb_plot[[focus_county]]$`Madras`
```
...
```{r echo = FALSE, message = FALSE, warning = FALSE,out.width="750px", out.height="500px", dpi=300}
ugb_plots$gr_compare[[focus_county]]$`Madras`
```
...
# Jefferson UGBs: Metolius in Context

.pux-right[
```{r echo = FALSE, message = FALSE, warning = FALSE,out.width="800px", out.height="400px", dpi=300}
ugb_plots$hist_pop_house_plot[[focus_county]]$`Metolius`
```
]
...
# Jefferson County: Metolius UGB Boundaries
...
# Metolius UGB Pop Forecast

```{r echo = FALSE, message = FALSE, warning = FALSE,out.width="750px", out.height="500px", dpi=300}
ugb_plots$ind_ugb_plot[[focus_county]]$`Metolius`
```
...
```{r echo = FALSE, message = FALSE, warning = FALSE,out.width="750px", out.height="500px", dpi=300}
ugb_plots$gr_compare[[focus_county]]$`Metolius`
```
