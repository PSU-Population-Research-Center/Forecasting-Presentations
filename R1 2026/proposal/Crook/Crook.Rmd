...
- Crook County's population growth has been consistent and high
- One of the fastest three growing counties in the state
- Last population forecasts reflect this
- No changes made
...
.pulll-left[
Crook county is expected to grow, albeit at a rate slower than what has been observed in the past.
]
...
# Crook Compositional Changes

.pulll-left[
Growth has been sustained by high migration to the county across a broad range of ages.
]
...
.pulll-left[
Births have been slightly increasing in the county but are expected to level off in the coming years.
]
...
.pulll-left[
Deaths have been on a steady rise in the county as the population continues to age.
]
...
.pulll-left[
The population aged 65 and over makes up a substantial portion of the county as of 2020.
]
...
# Crook Race and Ethnicity

.pulll-left[
All groups are expected to continue to grow in the forecast period.
]
...
# Crook UGBs: Prineville in Context

.pux-right[
```{r echo = FALSE, message = FALSE, warning = FALSE,out.width="800px", out.height="400px", dpi=300}
ugb_plots$hist_pop_house_plot[[focus_county]]$`Prineville`
```
]
...
# Crook County: Prineville UGB Boundaries
...
```{r echo = FALSE, message = FALSE, warning = FALSE,out.width="750px", out.height="500px", dpi=300}
ugb_plots$gr_compare[[focus_county]]$`Prineville`
```
