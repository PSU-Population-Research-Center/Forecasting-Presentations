...
![green_tech](./lakeview_article.png)

---
# Summary of Considerations

- Lake County's population growth has been consistent but slow
- Further deceleration is expected in the coming years
- Comments suggest alignment in slowing of growth
- No changes made

---


# Lake at a Glance: 2020 Census
...
.pulll-left[
Lake's population is expected to continue to grow albeit at a rate slower than observed in the past.
]
...
.pulll-left[
Births in the county have remained steady amid stable fertility rates.
]
...
.pulll-left[
Deaths have continued to rise as the population ages.
]
...
.pulll-left[
The population structure of the county is expected to remain relatively stable due to migration and higher than average fertility rates.
]
...
# Lake Race and Ethnicity

.pulll-left[
Growth in the county has been strongly driven by growth among the Hispanic population.
]
...
# Lake County: Lakeview UGB Boundaries
...
```{r echo = FALSE, message = FALSE, warning = FALSE,out.width="750px", out.height="500px", dpi=300}
ugb_plots$gr_compare[[focus_county]]$`Lakeview`
```
...
# Lake UGBs: Paisley in Context

.pux-right[
```{r echo = FALSE, message = FALSE, warning = FALSE,out.width="800px", out.height="400px", dpi=300}
ugb_plots$hist_pop_house_plot[[focus_county]]$`Paisley`
```
]
...
# Lake County: Paisley UGB Boundaries
...
# Paisley UGB Pop Forecast

```{r echo = FALSE, message = FALSE, warning = FALSE,out.width="750px", out.height="500px", dpi=300}
ugb_plots$ind_ugb_plot[[focus_county]]$`Paisley`
```
...
```{r echo = FALSE, message = FALSE, warning = FALSE,out.width="750px", out.height="500px", dpi=300}
ugb_plots$gr_compare[[focus_county]]$`Paisley`
```
